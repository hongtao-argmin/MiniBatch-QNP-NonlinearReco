...
par.stochGrad = 2;
par.gam = 7;
par.redStep = '';%reduced step at each iteration of FISTA
par.accel = '';
...
par.prox_iter = 300;%number of iterations for ADMM
...
par.snr = psnr(abs(uM.GTc - uem), abs(uM.curr_y - uem));
...
% params. for linear forward and liner reco. 

% for born dn=0.03 and par.gam = 1e2; -- 64^3 size
regul_set = 10;% for linear sim lin reco. born. [0.1;1;2;5;10;15;20;30;40;50;100];%[0.001;0.01;0.1;1];%[1e-6;1e-4;5e-4;5e-3;1e-2;5e-2;1e-1;1;1.5;2;5;10];%5;%10;%5e-2;%[5e-2;1e-1;1];%1e-4;1e-3;5e-3;1e-2;1e-1;6e-1;1e-4;1e-3;[1e-2;1;5;10];%[10,15,25,30];%,7,8[1,5];%,
regul_set = regul_set/prod(par.siz);
par.gam = 1e2;%*** for for linear sim lin reco. born for 64^4 case will scale in the reco. part. ***
